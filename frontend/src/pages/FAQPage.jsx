      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              ...
              Se você não estiver satisfeito com sua compra, aceitamos devoluções
                ...
                conosco em support@myecommercestore.com com o número do seu pedido e um
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              ...
              Você pode entrar em contato com nossa equipe de suporte ao cliente enviando um e-mail para
                support@myecommercestore.com ou ligando para (555) 123-4567
                entre 9h e 17h EST, de segunda a sexta.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
              Atualmente, oferecemos remessa apenas dentro de Moçambique.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
              no momento Aceitamos sistema de pagamento na entrega.
              </p>
            </div>
          )}
        </div>
